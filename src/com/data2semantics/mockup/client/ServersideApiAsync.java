...
public interface ServersideApiAsync {
	...
	void getChemicalStructure(AsyncCallback<String> callback) throws IllegalArgumentException,Exception;
	void getRelevantSnippet(AsyncCallback<HashMap<String, String>> callback) throws IllegalArgumentException;
	void query(String query, AsyncCallback<JsonObject> callback) throws IllegalArgumentException,Exception;
